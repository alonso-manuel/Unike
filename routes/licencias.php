...
Route::post('/licencias/confirmar-importacion', [LicenciaController::class, 'confirmarImportacion'])->name('licencias.confirmar.importacion');
Route::get('/licencias/importar', [LicenciaController::class, 'vistaImportar'])->name('licencias.importar.vista');
Route::post('/licencias/importar-excel', [LicenciaController::class, 'importarExcel'])->name('licencias.importar.excel');
